          ...
          <div className="dashboard__content bg-light-2">
            <div className="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
              <div className="col-12">
                <h1 className="text-30 lh-14 fw-600">Marketing</h1>
            ...
            <div className="row">
              <div className="col-3">
                <h1 className="text-18 lh-14 fw-600">Analyze performance</h1>
                <p className="text-14 text-light-1">
                  Gather and analyze data to gain insights on your business
                  performance and find areas to improve.
                </p>
              </div>
              <div className="col-9">
                <AnalyzeCards />
